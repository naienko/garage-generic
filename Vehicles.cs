...
namespace gary_garage
{
	...
	{  // Propellor light aircraft
		...
		{
			Console.WriteLine($"The {MainColor} Cessna is filled with {this.FuelCapacity} gallons of gas.");
		}
		public override void Drive() {
	...
	{  // Gas powered truck
		...
		public void RefuelTank()
		{
			Console.WriteLine($"The {MainColor} Ram is filled with {this.FuelCapacity} gallons of gas.");
		}
		public override void Drive() {
